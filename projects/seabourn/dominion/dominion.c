...
int tributeCardEffect(struct gameState* state, int nextPlayer, int *tributeRevealedCards, int handPos, int currentPlayer){
    ...
    for (int i = 0; i <= 2; i ++) {
        if (tributeRevealedCards[1] == copper || tributeRevealedCards[i] == silver || tributeRevealedCards[i] == gold) { //Treasure cards
            state->coins += 2;
        }
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        return mineCardEffect(choice1, choice2, state, handPos, currentPlayer);
    ...
    case baron:
        return baronCardEffect(choice1, state, handPos, currentPlayer);
    ...
    case tribute:
        return tributeCardEffect(state, nextPlayer, tributeRevealedCards, handPos, currentPlayer);
